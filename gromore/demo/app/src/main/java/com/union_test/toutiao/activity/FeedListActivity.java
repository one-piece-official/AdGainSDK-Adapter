    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private View getVerticalAdView(View convertView, ViewGroup parent, @NonNull final TTFeedAd ad) {
            ...
            if (convertView == null) {
                ...
                adViewHolder.mComplianceRegNumber = (TextView) convertView.findViewById(R.id.reg_number);
...
//            creativeViewList.add(convertView);
            ...
            if (complianceInfo != null) {
                ...
                if (adViewHolder.mComplianceRegNumber != null) {
                    adViewHolder.mComplianceRegNumber.setText(regNumber);
                }
            }
